...
public class SpecialityAdapter extends RecyclerView.Adapter<SpecialityAdapter.RecyclerViewHolder> {
    private final Context context;
    private final List<SpecialityModel> dataModelList;

    public SpecialityAdapter(Context context, List<SpecialityModel> dataModelList) {
